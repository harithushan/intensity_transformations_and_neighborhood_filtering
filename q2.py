...
def accentuate_range(img, low, high):
    cps = [(0,0), (low,0), (high,255), (255,255)]
...
import numpy as np
from utils import (
    load_gray, save_img, plot_transfer, apply_lut, intensity_map_from_points, hist_img
)

IN_PATH = "docs/q2_images/input/brain_proton_density_slice.png"

def accentuate_range(img, low, high):
    # Piecewise mapping: dim outside, stretch inside range
    cps = [(0,0), (low,0), (high,255), (255,255)]
    lut = intensity_map_from_points(cps)
    return apply_lut(img, lut), lut
...
def main():
    ...
    hist_img(img, "Q2 Brain Histogram", "docs/q2_images/output/q2_histogram.png")
